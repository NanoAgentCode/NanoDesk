...
pub const LEGACY_IDENTIFIER: &str = env!("APP_LEGACY_BUNDLE_IDENTIFIER");
pub const LEGACY_STORAGE_PREFIX: &str = env!("APP_LEGACY_STORAGE_PREFIX");
pub const LEGACY_PROJECT_DATA_DIRECTORY: &str = env!("APP_LEGACY_PROJECT_DATA_DIRECTORY");
